...
if __name__ == "__main__":
    for iteration in range(10):
        # Runs MCTS
        net_to_play = "initial_model.pth.tar"
        ...
        processes1 = []
        for i in range(2):
            p1 = mp.Process(target=MCTS_self_play, args=(net, 500, i, "iter0"))
            p1.start()
        ...
        # Runs Net training
        net_to_train = "trained1_iter4.pth.tar"
        save_as = "trained1_iter5.pth.tar"
        # gather data
        ...
        # save results
        torch.save(
            {"state_dict": net.state_dict()}, os.path.join("./model_data/", save_as)
        )
